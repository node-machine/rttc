...
module.exports = function _validateRecursive (expected, actual, errors){
  ...
  // if `actual` is an unexpected buffer or stream, coerce it to an empty object
  ...
  //
  // Special exception to JSON serialization rule if expecting a "machine", "buffer", or "stream"
  // (note that buffers and streams may only be included at the top-level.)
  ...
  // TODO: probably should clone machine defs
