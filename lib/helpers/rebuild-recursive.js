...
module.exports = function rebuildRecursive(val, handleLeafTransform) {
  ...
  if (!_.isFunction(handleLeafTransform)){
    throw new Error('Usage: A transformer function must be provided as the second argument to `rttc.rebuildRecursive()`.  Instead, got: '+util.inspect(handleLeafTransform, {depth:null}));
  }
