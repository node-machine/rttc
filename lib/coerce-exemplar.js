...
module.exports = function coerceExemplar (value, allowSpecialSyntax, treatTopLvlUndefinedAsRef) {
  ...
  // (note that this isn't quite 1-to-1 with reality, since `===` doesn't
  //  accept `undefined` values as of rttc@9.3.0, doesn't accept )
  if (treatTopLvlUndefinedAsRef && _.isUndefined(value)) {
    return '===';
  }
